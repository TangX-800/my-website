...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ro(e,t,n){let r=new Float32Array(Wa),i=new G(0,1,0);return new Ni({name:`SphericalGaussianBlur`,defines:{n:Wa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:oo(),fragmentShader:`
	...
	`}var so=class extends nn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new yi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main(){
  ...
  #include <colorspace_fragment>
}`,Qc=`varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,$c=`
...
}`;function el(e){let t=document.createElement(`canvas`);t.width=1536,t.height=Math.round(t.width/e);let n=t.getContext(`2d`);if(n){let e=t.height/1172,r=62*e,i=31*e,a=80*e,o=t.width-r-a/2,s=t.height-i-a/2;n.fillStyle=`black`,n.beginPath(),n.arc(o,s,a/2,0,Math.PI*2),n.fill(),n.strokeStyle=`white`,n.lineWidth=Math.max(3,5*e),n.lineCap=`round`,n.lineJoin=`round`;let c=a*.19;n.beginPath(),n.moveTo(o-c,s),n.lineTo(o+c,s),n.moveTo(o+c*.2,s-c*.75),n.lineTo(o+c,s),n.lineTo(o+c*.2,s+c*.75),n.stroke()}let r=new bi(t);return r.colorSpace=Ke,r.minFilter=_,r}function tl(){let e=(0,l.useRef)(null),t=(0,l.useRef)(null),[n,r]=(0,l.useState)(!1),[i,a]=(0,l.useState)(!1),[o,s]=(0,l.useState)(0);return(0,l.useEffect)(()=>{let e=t.current;e&&(i&&!e.open&&e.showModal(),!i&&e.open&&e.close())},[i]),(0,l.useEffect)(()=>{let n=e.current;if(!n)return;let i=!1,o=0,c=!1,l=!1,u=0,d=0,f=0,p=performance.now(),m=-1e3,h=-1e3,g=0,v=0,y=0,b=0,x=performance.now(),S=0,C=!1,w=1,T=1,E=1,D=1,O=1,k=1,ee=new Un;ee.background=new Vn(0);let A=new da(53.4,1,.1,2e3);A.position.z=41.18;let te=new Kc({canvas:n,antialias:!0,powerPreference:`high-performance`});te.setPixelRatio(Math.min(2,window.devicePixelRatio)),te.outputColorSpace=Ke,te.toneMapping=0,te.toneMappingExposure=1;let j=new Ti(1,1,48,24),ne=[],M=(e,t,n,r=!1,i=e,a=!1)=>({uTexture:{value:e},uRevealTexture:{value:i},uMedia:{value:new W(t,n)},uRes:{value:new W(1,1)},uAlpha:{value:0},uCorner:{value:.052},uW:{value:1},uD:{value:1},uT:{value:1.15},uV:{value:0},uLean:{value:0},uHover:{value:0},uDent:{value:.1},uLabel:{value:+!!r},uSpecial:{value:+!!a},uRipple:{value:0},uWaveTime:{value:0},uPointer:{value:new W(.5,.5)}}),N=new Ni({vertexShader:Qc,fragmentShader:$c,uniforms:{uAlpha:{value:0}},transparent:!0,depthTest:!1,depthWrite:!1}),P=new Ti(1,1);P.rotateX(-Math.PI/2);let re=new oi(P,N);ee.add(re);async function ie(e){let t=Jc[e],n,r,i;if(e===0){let e=new ra;[n,r]=await Promise.all([e.loadAsync(t[4]),e.loadAsync(t[4])])}else t[5]?(i=document.createElement(`video`),i.src=t[4],i.muted=!0,i.loop=!0,i.playsInline=!0,i.preload=`auto`,await new Promise(e=>{let t=!1,n=()=>{t||(t=!0,window.clearTimeout(r),i.removeEventListener(`canplay`,n),i.removeEventListener(`error`,n),e())},r=window.setTimeout(n,2400);i.readyState>=2?n():(i.addEventListener(`canplay`,n,{once:!0}),i.addEventListener(`error`,n,{once:!0}),i.load())}),n=new vi(i),n.minFilter=_,n.magFilter=_,n.generateMipmaps=!1):n=await new ra().loadAsync(t[4]);n.colorSpace=Ke,r&&(r.colorSpace=Ke);let a=new oi(j,new Ni({vertexShader:Xc,fragmentShader:Zc,uniforms:M(n,t[2],t[3],!1,r,e===0),transparent:!0,depthTest:!1,depthWrite:!1,side:2,toneMapped:!1}));a.renderOrder=10;let o=el(t[2]/t[3]),s=new oi(j,new Ni({vertexShader:Xc,fragmentShader:Zc,uniforms:M(o,t[2],t[3],!0,o,e===0),transparent:!0,depthTest:!1,depthWrite:!1,side:2,toneMapped:!1}));s.renderOrder=20,ee.add(a,s),ne.push({index:e,mesh:a,label:s,texture:n,revealTexture:r,video:i,left:0,width:0,hover:0,ripple:0,waveTime:0,pointer:new W(.5,.5),screen:{left:1/0,right:-1/0,top:1/0,bottom:-1/0}})}Promise.allSettled(Jc.map((e,t)=>ie(t))).then(()=>{if(i)return;ne.sort((e,t)=>e.index-t.index),ae();let e=ne[0];e&&(g=v=w*.5-(e.left+e.width/2)),ne.forEach(e=>void e.video?.play().catch(()=>{})),window.setTimeout(()=>{C=!0,r(!0)},820)});function ae(){w=Math.max(1,n.clientWidth),T=Math.max(1,n.clientHeight),te.setSize(w,T,!1),A.aspect=w/T,A.updateProjectionMatrix(),k=Math.tan(It.degToRad(A.fov)/2)*A.position.z,O=k*A.aspect,E=Math.min(T*.435,550);let e=0;ne.forEach(t=>{t.left=e,t.width=E*Jc[t.index][2]/Jc[t.index][3],e+=t.width+10}),D=Math.max(1,e);let t=k*2*E/T;re.position.set(0,-t/2-k*.06,-39),re.scale.set(O*8,1,k*12)}function oe(e){let t=e.left+e.width/2+g;return w/2+Yc(t-w/2,D)}function se(e,t){return ne.filter(n=>{let r=n.screen;return Number.isFinite(r.left)?e>=r.left-8&&e<=r.right+8&&t>=r.top-8&&t<=r.bottom+8:Math.abs(e-oe(n))<=n.width/2&&t>=(T-E)/2&&t<=(T+E)/2}).sort((t,n)=>{let r=(t.screen.left+t.screen.right)/2,i=(n.screen.left+n.screen.right)/2;return Math.abs(e-r)-Math.abs(e-i)})[0]??null}let F=new G;function I(e,t,n,r,i,a,o){let s=1/0,c=-1/0,l=1/0,u=-1/0;for(let e=0;e<=6;e++)for(let d=0;d<=4;d++){let f=t+(e/6-.5)*n,p=(d/4-.5)*r,m=0,h=f/Math.max(O,1e-4)*1.15-.2,g=(Math.PI*Math.cos(Math.PI*h)-2*h*Math.sin(Math.PI*h))*Math.exp(-h*h),_=It.smoothstep(Math.abs(f/O),.3,.9),v=-.16*g/Math.PI+1.8*o*_*Math.sign(f),y=Math.sin(v),b=Math.cos(v),x=p*b-m*y;m=p*y+m*b,p=x,m+=-i*Math.sin(Math.PI*h)*Math.exp(-h*h),p+=.03*f;let S=1-It.smoothstep(f/O,-1,.3);p+=.1*O*o*S,m+=.2*O*o*S;let C=It.clamp(f/O,-1,1);m+=a*C*(1.5-.5*C*C),F.set(f,p,m).project(A);let E=(F.x*.5+.5)*w,D=(-F.y*.5+.5)*T;s=Math.min(s,E),c=Math.max(c,E),l=Math.min(l,D),u=Math.max(u,D)}e.screen={left:s,right:c,top:l,bottom:u}}function ce(e){e.button===0&&(c=!0,l=!1,u=e.clientX,d=v,f=e.clientX,p=performance.now(),y=0,m=e.clientX,h=e.clientY,n.setPointerCapture(e.pointerId),n.style.cursor=`grabbing`)}function le(e){if(m=e.clientX,h=e.clientY,!c)return;let t=e.clientX-u;Math.abs(t)>3&&(l=!0),v=d+t;let n=performance.now(),r=Math.max(8,n-p);y=(e.clientX-f)/r*1e3,f=e.clientX,p=n}function ue(e){if(c&&(c=!1,n.style.cursor=`grab`,!l)){let n=se(e.clientX,e.clientY);if(n){let r=w/2-oe(n),i=Math.abs(r)<Math.min(24,w*.04),o=Math.abs(v-g)<3&&Math.abs(b)<.03;y=0,i&&o?(s(n.index),t.current&&(t.current.dataset.touchOpened=String(e.pointerType===`touch`)),a(!0)):v=g+r}}}function de(){c=!1,l=!0,y=0,n.style.cursor=`grab`}function fe(){m=-1e3,h=-1e3,c||(n.style.cursor=`grab`)}function pe(e){e.preventDefault();let t=e.deltaX+e.deltaY;v-=t,y=It.clamp(y-t*7.5,-2200,2200)}function me(e){t.current?.open||(e.key===`Escape`&&a(!1),e.key===`ArrowLeft`&&(v+=420,y=0),e.key===`ArrowRight`&&(v-=420,y=0))}function he(e){let t=Math.min(.05,Math.max(.004,(e-x)/1e3));x=e,C&&(S+=(1-S)*(1-Math.exp(-5.2*t))),!c&&Math.abs(y)>1?(v+=y*t,y*=Math.exp(-3.05*t)):c||(y=0),g+=(v-g)*(1-Math.exp(-(c?15.5:7.4)*t)),Math.abs(g)>D*2&&(g=Yc(g,D),v=g);let r=y+(v-g)*6.2,i=.52*Math.tanh(r/720),a=Math.abs(i)>Math.abs(b)?10.5:3.15;b+=(i-b)*(1-Math.exp(-a*t));let s=b,l=Math.abs(s),u=O*.19*(1+1.7*l),d=O*(-.045-.17*s),f=m<0?w/2:m,p=h<0?T/2:h,_=(f/w-.5)*2.2,j=-(p/T-.5)*1;A.position.x+=(_-A.position.x)*(1-Math.exp(-3.5*t)),A.position.y+=(j-A.position.y)*(1-Math.exp(-3.5*t)),A.lookAt(0,0,0),ne.forEach(e=>{let t=oe(e),n=O*2*e.width/w,r=k*2*E/T,i=-O+t/w*O*2;I(e,i,n,r,u,d,s);for(let t of[e.mesh,e.label]){t.position.set(i,0,0),t.scale.set(n,r,1);let a=e.hover*.1;t.rotation.x=(e.pointer.y-.5)*-a,t.rotation.y=(e.pointer.x-.5)*a;let o=t.material.uniforms;o.uRes.value.set(n,r),o.uW.value=O,o.uD.value=u,o.uT.value=1.15,o.uV.value=s,o.uLean.value=d,o.uHover.value=e.hover,o.uAlpha.value=S}});let M=c?null:se(m,h);ne.forEach(e=>{let n=+(e===M);if(e.hover+=(n-e.hover)*(1-Math.exp(-(n?13.5:10.5)*t)),e.index===0?e.ripple=It.clamp(e.ripple+(n?t/1.55:-t/.8),0,1):e.ripple+=(n-e.ripple)*(1-Math.exp(-(n?7.5:9)*t)),n?e.waveTime+=t:e.ripple<.01&&(e.waveTime=0),n){let n=e.screen,r=It.clamp((m-n.left)/Math.max(1,n.right-n.left),.08,.92),i=It.clamp(1-(h-n.top)/Math.max(1,n.bottom-n.top),.1,.9);e.pointer.lerp(new W(r,i),1-Math.exp(-10*t))}for(let t of[e.mesh,e.label]){let n=t.material.uniforms;n.uHover.value=e.hover,n.uRipple.value=e.ripple,n.uWaveTime.value=e.waveTime,n.uPointer.value.copy(e.pointer)}}),n.dataset.hoveredCard=M?String(M.index):`none`,n.dataset.nathanRipple=ne[0]?ne[0].ripple.toFixed(3):`0`,n.dataset.rippleValues=ne.map(e=>e.ripple.toFixed(3)).join(`,`),c||(n.style.cursor=M?`pointer`:`grab`),N.uniforms.uAlpha.value=S*.82,te.render(ee,A),o=requestAnimationFrame(he)}return ae(),window.addEventListener(`resize`,ae),window.addEventListener(`keydown`,me),n.addEventListener(`pointerdown`,ce),n.addEventListener(`pointermove`,le),n.addEventListener(`pointerup`,ue),n.addEventListener(`pointercancel`,de),n.addEventListener(`pointerleave`,fe),n.addEventListener(`wheel`,pe,{passive:!1}),o=requestAnimationFrame(he),()=>{i=!0,cancelAnimationFrame(o),window.removeEventListener(`resize`,ae),window.removeEventListener(`keydown`,me),n.removeEventListener(`pointerdown`,ce),n.removeEventListener(`pointermove`,le),n.removeEventListener(`pointerup`,ue),n.removeEventListener(`pointercancel`,de),n.removeEventListener(`pointerleave`,fe),n.removeEventListener(`wheel`,pe),ne.forEach(e=>{e.video?.pause(),e.texture.dispose(),e.revealTexture?.dispose(),e.label.material.uniforms.uTexture.value.dispose(),e.mesh.material.dispose(),e.label.material.dispose()}),j.dispose(),P.dispose(),N.dispose(),te.dispose()}},[]),(0,Q.jsxs)(`main`,{className:`gallery-stage`,children:[(0,Q.jsxs)(`header`,{className:`site-header`,children:[(0,Q.jsx)(`span`,{children:`Portfolio`}),(0,Q.jsx)(`span`,{children:`2026`})]}),(0,Q.jsx)(`canvas`,{ref:e,className:`webgl-gallery`,"data-testid":`webgl-gallery`,"aria-label":`Draggable WebGL project gallery`,tabIndex:0}),(0,Q.jsxs)(`footer`,{className:`site-footer`,children:[(0,Q.jsx)(`nav`,{"aria-label":`Project views`,children:(0,Q.jsx)(`strong`,{children:`TANG`})}),(0,Q.jsx)(`span`,{children:`UPDATING...`})]}),(0,Q.jsxs)(`div`,{className:`loading-screen${n?` is-hidden`:``}`,"aria-hidden":`true`,children:[(0,Q.jsx)(`i`,{}),(0,Q.jsx)(`i`,{}),(0,Q.jsx)(`i`,{})]}),(0,Q.jsxs)(`dialog`,{ref:t,className:`detail-overlay`,"aria-labelledby":`detail-title`,onKeyDown:e=>{delete e.currentTarget.dataset.touchOpened,e.key===`Tab`&&(e.preventDefault(),e.currentTarget.querySelector(`button`)?.focus())},onClose:()=>{a(!1),e.current?.focus({preventScroll:!0})},children:[(0,Q.jsxs)(`header`,{className:`detail-header`,children:[(0,Q.jsx)(`h2`,{id:`detail-title`,children:Jc[o][1]}),(0,Q.jsx)(`button`,{className:`detail-hit-close`,onClick:()=>a(!1),"aria-label":`关闭详情`,children:(0,Q.jsx)(`svg`,{width:`20`,height:`20`,viewBox:`0 0 24 24`,fill:`none`,"aria-hidden":`true`,children:(0,Q.jsx)(`path`,{d:`M6 6L18 18M18 6L6 18`,stroke:`currentColor`,strokeWidth:`1.5`,strokeLinecap:`round`})})})]}),(0,Q.jsx)(`img`,{className:`detail-portrait`,src:Jc[o][4],alt:Jc[o][1]}),(0,Q.jsx)(`footer`,{className:`detail-caption`,children:`TANG / TO BE ADDED`})]})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,Q.jsx)(tl,{}));